...
use vars qw($opt_f $opt_k $opt_i $opt_c $opt_o);
...
print "output in $output_file.temp in temperary\n".
open OUTPUT_FILE, "> $output_file.temp";
#第一行如果是日期时间, 脚本没法识别
print OUTPUT_FILE "\n";
