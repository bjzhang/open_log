...
The audience is anyone interested in Kernel/libc testing. Attendees can understand the idea and how to use these fuzz tools in their environment.
...
This presentation will help existing and new kernel developers/testers improve the coverage and stability.
