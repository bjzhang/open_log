...
1.  杂
    ...
    9.  13:03-13:20 总结上午看的cloud computing部分。感觉现在这个记忆力根本记不下来，字都认识完全没有感觉。。。
        1.  TODO: raft和gossip什么关系? 看起来raft或paxos和gossip场景不同。
...
1.  golang opencv
    ...
    2.  16:13-16:54 忘了计时。
        ...
        3.  NEXT: 考虑用houge line transform检测直线<https://docs.opencv.org/3.0-beta/doc/py_tutorials/py_imgproc/py_houghlines/py_houghlines.html>
1.  晚上：
    1.  做饭。
    2.  洗衣服。
    2.  心理团体报名。
    3.  如果没法记录时间说明累了，洗漱睡觉。二选一：
        1.  试试go的channel。
        1.  用go统计每天工作时间。
    4.  又有点想写自己的职业规划。要不学学用golang画图？
1.  NEXT
    1.  每天讨论一下下。
    1.  macbook air重装方案。
    1.  看看我的icloud是不是被关闭了
