...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    static public final String SYSTEM_DIALOG_REASON_MAGIC_BAR = "magicbar";
...
//    RecentApplicationsDialog mRecentAppsDialog;
	...
	//modified by lj
    public void setLockState(boolean flag){
    	Log.i("PhoneWindowManager","setLockState");
    	m_bLockflag = flag;
    }
    
    //modified by lj
    public boolean getLockState(){
    	Log.i("PhoneWindowManager","getLockState");
    	return m_bLockflag;
    }
    ...
    class MyOrientationListener extends WindowOrientationListener {
        ...
        public void onOrientationChanged(int rotation) {
            ...
            try {
				//modified by lj
            	Log.i("PhoneWindowManager","onOrientationChanged");
            	if(m_bLockflag){
					Log.i("PhoneWindowManager","onOrientationChanged m_bLockflag=true");
            		return;
            	}
...
//            showRecentAppsDialog();
            sendCloseSystemWindows(SYSTEM_DIALOG_REASON_MAGIC_BAR);
            showMagicBar();
        }
    };
...
//    }
     ...
     */
    void showMagicBar() {
        Intent it = new Intent("android.app.action.ACTION_ENTER_MAGICBAR");
...
//                    orientation == ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);
            mOrientationListener.setAllow180Rotation(true);//by lj
