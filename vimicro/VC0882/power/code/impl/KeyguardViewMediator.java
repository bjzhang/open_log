        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case TIMEOUT:
                    ...
                    return ;
                case SHOW:
                	//ZY:Disable TPI Calibrating screen
					/*
					File file = new File("data/data/com.android.settings/files", "SCREEN_REGULATOR.txt");
                    if (file.length() > 0) {
                        Log.i(TAG, "screen regulator config file exists,show lockscreen");
						handleShow();
                    }
                    file = null;
					*/
