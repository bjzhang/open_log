...
5.  其它有用的信息：
    1.  mksquashfs
        ...
        ```
    2.  如果提示lvm的vg已经存在，可以重启lvm2-lvmetad.service: `sudo systemctl restart lvm2-lvmetad.service`，参考<https://groups.google.com/d/msg/kiwi-images/gO5apLcysUc/zygqLGmhAgAJ>
...
3.  TODO
    1.  添加cloud-user到/etc/sudoers.d/ceph失败。文件不存在。
    2.  添加smbuser
    3.  安装后还要配置yum源么?
    4.  光盘安装后启动有问题，原因是没有lvm命令。
